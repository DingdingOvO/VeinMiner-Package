    ...
    static async show(player) {
        try {
            ...
            switch (response.selection) {
                case 0:
                    await ServerLimitsUI.show(player);
                    break;
                case 1:
                    await ServerBlacklistUI.show(player);
                    break;
                case 2:
                    await ServerWhitelistExtraUI.show(player);
                    break;
                case 3:
                    await ServerDimensionUI.show(player);
                    break;
                case 4:
                    await ServerRateLimitUI.show(player);
                    break;
                case 5:
                    await ServerPlayerOverrideUI.show(player);
                    break;
                case 6:
                    await ServerCooldownUI.show(player);
                    break;
                case 7:
