...
export class I18n {
     ...
     */
    static detectPlayerLang(player) {
        try {
            const pref = player.getDynamicProperty('veinminer:lang');
     ...
     * 设置玩家语言偏好
     */
    static setPlayerLang(player, lang) {
        try {
