...
export { CommandRegistry, CommandBase, VeinCommand, VeinToggleCommand, VeinStatusCommand, VeinBlacklistCommand, VeinWhitelistCommand, VeinLimitCommand, VeinReloadCommand, VeinResetCommand, VeinRateCommand };
/**
 * 注册所有命令（启动时调用）
 */
